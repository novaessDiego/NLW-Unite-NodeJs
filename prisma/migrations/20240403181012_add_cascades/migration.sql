...
CREATE TABLE "new_check_ins" (
    ...
    CONSTRAINT "check_ins_eattendee_id_fkey" FOREIGN KEY ("eattendee_id") REFERENCES "attendees" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_check_ins" ("created_at", "eattendee_id", "id") SELECT "created_at", "eattendee_id", "id" FROM "check_ins";
